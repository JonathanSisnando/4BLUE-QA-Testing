# Desafio Técnico de QA - 4BLUE

## 1. Informações da Tarefa
**Objetivo:** Realizar a verificação e validação do módulo de autenticação (Criar Conta e Login) da plataforma simulada 4BLUE.
...
## 2. Resposta e Artefatos Gerados
...
* **[Localização Erros (Issues)](https://github.com/JonathanSisnando/4BLUE-QA-Testing/issues):**
